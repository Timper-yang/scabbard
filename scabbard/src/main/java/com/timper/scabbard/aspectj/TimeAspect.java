...
@Aspect public class TimeAspect {
  ...
  @Pointcut("execution(@com.timper.scabbard.annotations.Time * *(..))") public void methodAnnotated() {
  }

  @Pointcut("execution(@com.timper.scabbard.annotations.Time *.new(..))") public void constructorAnnotated() {
  }
